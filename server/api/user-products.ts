...
router.get("/:userId", async (req: Request, res: Response) => {
  try {
    ...
    // Use the storage method that now consistently uses direct SQL with proper transformation
    logger.debug(`GET /user-products/:userId - Fetching user products using refined storage methods`, {
      userId,
      requestId: req.id
    });
